...
public class Drivetrain extends SubsystemBase {
  ...
  // Shifting Gearboxes
  private static final Solenoid starboardSolenoid = new Solenoid(Constants.CANIds.Starboard_Solenoid_ID);
  private static final Solenoid portSolenoid = new Solenoid(Constants.CANIds.Port_Solenoid_ID);
